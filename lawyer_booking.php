				...
				<div class="d-flex" id="wrapper">
					...
					<div class="bg-light border-right" id="sidebar-wrapper">
						...
						<div class="list-group list-group-flush">
							...
							<a href="update_password_lawyer.php" class="list-group-item list-group-item-action bg-light">Update Password</a>
						</div>
					</div>
					<!-- /#sidebar-wrapper -->
											...
											<?php
												...
												<tbody id="myTable">
													<tr>
														...
														<?php }?>
														<td><a class="btn btn-sm btn-danger" href="lawyer_booking.php?delete_id=<?=$row['booking_id']?>">Delete</a></td>
													</tr>

													<?php
													/*To delete the lawyer*/

						if (isset($_GET['delete_id'])) {
			
			$b_id = $_GET['delete_id'];

			$updateSql = "DELETE FROM booking WHERE booking_id='$b_id'";
			$deta=mysqli_query($conn,$updateSql);
			if($deta){
				header('location: lawyer_booking.php');
			}
